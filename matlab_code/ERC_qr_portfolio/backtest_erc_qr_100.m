...
ret_100_erc_qr = zeros(n_rebals, 1);
time_weights_100_erc_qr = zeros(n_rebals, n_stocks);
time_rets_100_erc_qr = zeros(n_rebals, n_stocks);
for i = 1:n_rebals
    ...
    ret_100_erc_qr(i) = sum(weights_now'.*month_ret(i, :));
    
    time_weights_100_erc_qr(i, :) = weights_now;
    time_rets_100_erc_qr(i, :) = month_ret(i, :);
    i
end

save('ret_100_erc_qr.mat', 'ret_100_erc_qr', 'time_weights_100_erc_qr', 'time_rets_100_erc_qr', 'tickers_grouped_100')
