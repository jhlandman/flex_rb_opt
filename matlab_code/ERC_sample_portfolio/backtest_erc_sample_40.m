...
% declaring matrices
ret_40_erc_sample = zeros(n_rebals, 1);
...
for i = 1:n_rebals
    ...
    ret_40_erc_sample(i) = sum(weights_now'.*month_ret(i, :));
    time_weights_40_erc(i, :) = weights_now;
    time_rets_40_erc(i, :) = month_ret(i, :);
    % print interation
    i
    lambda_opt
end

save('ret_40_erc_sample.mat', 'ret_40_erc_sample', 'time_weights_40_erc', 'time_rets_40_erc', 'tickers_grouped_40')
