...
tickers_grouped_40 = string(NaN(n_rebals, stocks_incl));
...
for i = 1:n_rebals
    ...
    incl_stocks = incl_40_week(weekly_dates == rebal_date_now, :);
    ...
    tickers_grouped_40(i, :) = weekly_ticks(incl_stocks); 
    ...
    month_weights_temp = mean(weight_mat_40_week(weeks_incl, incl_stocks));
...
save('/Users/jaysonlandman/Desktop/research for masters/code_300_window/data_man/backtest_40_dat.mat', 'weekly_ret_grouped', 'rebal_dates_grouped', 'tickers_grouped_40', 'month_ret', 'month_dates', 'month_weights')
