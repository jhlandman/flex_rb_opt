function [lam_star] = k_folds_cross_erc(returns_stocks_weekly, lambda, n_iter, n_groups, mean_ret)
...
find_obj_func = @(tau) find_max_sigdiff(tau, returns_split, lambda, mean_ret);
