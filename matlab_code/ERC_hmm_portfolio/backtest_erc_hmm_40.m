...
% allocating memory
ret_40_erc_hmm = zeros(n_rebals, 1);
time_weights_40_erc = zeros(n_rebals, n_stocks);
time_rets_40_erc = zeros(n_rebals, n_stocks);
for i = 1:n_rebals
    ...
    % allocating results
    ret_40_erc_hmm(i) = sum(weights_now'.*month_ret(i, :));
    time_weights_40_erc_hmm(i, :) = weights_now;
    time_rets_40_erc_hmm(i, :) = month_ret(i, :);
    i
end

save('ret_40_erc_hmm.mat', 'ret_40_erc_hmm', 'time_weights_40_erc_hmm', 'time_rets_40_erc_hmm', 'tickers_grouped_40')
