...
% allocating memeory
ret_100_erc_be = zeros(n_rebals, 1);
time_weights_100_erc_be = zeros(n_rebals, n_stocks);
time_rets_100_erc_be = zeros(n_rebals, n_stocks);
for i = 1:n_rebals
    ...
    ret_100_erc_be(i) = sum(weights_now'.*month_ret(i, :));
    
    time_weights_100_erc_be(i, :) = weights_now;
    time_rets_100_erc_be(i, :) = month_ret(i, :);
    i
end

save('ret_100_erc_be.mat', 'ret_100_erc_be', 'time_weights_100_erc_be', 'time_rets_100_erc_be', 'tickers_grouped_100')
