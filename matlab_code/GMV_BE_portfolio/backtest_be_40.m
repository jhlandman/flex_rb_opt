...
time_weights_40_gmv_be = zeros(n_rebals,  n_stocks);
time_rets_40_gmv_be = zeros(n_rebals,  n_stocks);

ret_40_gmv_be = zeros(n_rebals, 1);
for i = 1:n_rebals
    ...
    ret_40_gmv_be(i) = sum(weights_now'.*month_ret(i, :));
    time_weights_40_gmv_be(i, :) = weights_now;
    time_rets_40_gmv_be(i, :) = month_ret(i, :);
    i
end

save('ret_40_gmv_be.mat', 'ret_40_gmv_be', 'time_weights_40_gmv_be', 'time_rets_40_gmv_be', 'tickers_grouped_40')

std(ret_40_gmv_be).*sqrt(12)