...
time_weights_40_gmv_qr = zeros(n_rebals,  n_stocks);
time_rets_40_gmv_qr = zeros(n_rebals,  n_stocks);

ret_40_gmv_qr = zeros(n_rebals, 1);
for i = 1:n_rebals
    ...
    ret_40_gmv_qr(i) = sum(weights_now'.*month_ret(i, :));
    time_rets_40_gmv_qr(i, :) = month_ret(i, :);
    time_weights_40_gmv_qr(i, :) = weights_now;
    i
end

save('ret_40_gmv_qr.mat', 'ret_40_gmv_qr', 'time_rets_40_gmv_qr', 'time_weights_40_gmv_qr', 'tickers_grouped_40')