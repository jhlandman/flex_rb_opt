...
\CommentTok{\# MW returns and weights {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{mw\_month\_rebal \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(date)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top40\_ret\_contrib =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_ret }\OperatorTok{*}\StringTok{ }\NormalTok{.data}\OperatorTok{$}\NormalTok{top40\_weight) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top100\_ret\_contrib =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_ret }\OperatorTok{*}\StringTok{ }\NormalTok{.data}\OperatorTok{$}\NormalTok{top100\_weight) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top40\_total\_ret =} \KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{top40\_ret\_contrib)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top100\_total\_ret =} \KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{top100\_ret\_contrib)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{month\_index, }
\NormalTok{      .data}\OperatorTok{$}\NormalTok{name, }
\NormalTok{      .data}\OperatorTok{$}\NormalTok{month\_ret, }
\NormalTok{      .data}\OperatorTok{$}\NormalTok{top40\_weight,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{top40\_ret\_contrib,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{top40\_total\_ret,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{top100\_weight,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{top100\_ret\_contrib,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{top100\_total\_ret}
\NormalTok{    )}

\CommentTok{\# EW returns and weights {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{ew\_month\_rebal \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(date)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ew40\_weight =} \KeywordTok{if\_else}\NormalTok{(.data}\OperatorTok{$}\NormalTok{top40\_weight }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{, }\DecValTok{1} \OperatorTok{/}\StringTok{ }\DecValTok{40}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ew100\_weight =} \KeywordTok{if\_else}\NormalTok{(.data}\OperatorTok{$}\NormalTok{top100\_weight }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{, }\DecValTok{1} \OperatorTok{/}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ew40\_ret\_contrib =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_ret }\OperatorTok{*}\StringTok{ }\NormalTok{.data}\OperatorTok{$}\NormalTok{ew40\_weight) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ew100\_ret\_contrib =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_ret }\OperatorTok{*}\StringTok{ }\NormalTok{.data}\OperatorTok{$}\NormalTok{ew100\_weight) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ew40\_total\_ret =} \KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{ew40\_ret\_contrib)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ew100\_total\_ret =} \KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{ew100\_ret\_contrib)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{month\_index, }
\NormalTok{      .data}\OperatorTok{$}\NormalTok{name, }
\NormalTok{      .data}\OperatorTok{$}\NormalTok{month\_ret, }
\NormalTok{      .data}\OperatorTok{$}\NormalTok{ew40\_weight,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{ew40\_ret\_contrib,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{ew40\_total\_ret,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{ew100\_weight,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{ew100\_ret\_contrib,}
\NormalTok{      .data}\OperatorTok{$}\NormalTok{ew100\_total\_ret}
\NormalTok{    )}

\CommentTok{\# GMV sample covar returns and weights {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\CommentTok{\# out \textless{}{-} model\_rebal\_dat$data[[1]]}
\CommentTok{\# }
\CommentTok{\# tmp \textless{}{-} out \%\textgreater{}\% }
\CommentTok{\#   filter(.data$histadj\_top40\_weight \textgreater{} 0) \%\textgreater{}\% }
\CommentTok{\#   select(.data$date, .data$name, .data$week\_ret) \#\%\textgreater{}\% }
\CommentTok{\#   pivot\_wider(id\_cols = c("date", "name"), names\_from = c("name"), values\_from = c("week\_ret")) \%\textgreater{}\% }
\CommentTok{\#   select({-}.data$date)}

\CommentTok{\# Sorted out NAs, but now need to sort out data repitition, not sure where it is coming from...}
\CommentTok{\# see data preparation, almost have a covar mat}
...
\NormalTok{weekly\_ret \textless{}{-}}\StringTok{ }\NormalTok{weekly\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\StringTok{"date"}\NormalTok{ =}\StringTok{ "...1"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{as.Date}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date)) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{pivot\_longer}\NormalTok{(}\KeywordTok{setdiff}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(weekly\_ret), }\KeywordTok{c}\NormalTok{(}\StringTok{"...1"}\NormalTok{))) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{drop\_na}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{join\_col =} \KeywordTok{paste0}\NormalTok{(}\KeywordTok{month}\NormalTok{(date), }\KeywordTok{year}\NormalTok{(date)))}

\NormalTok{month\_ret \textless{}{-}}\StringTok{ }\NormalTok{month\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\StringTok{"date"}\NormalTok{ =}\StringTok{ "...1"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{as.Date}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date)) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{pivot\_longer}\NormalTok{(}\KeywordTok{setdiff}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(month\_ret), }\KeywordTok{c}\NormalTok{(}\StringTok{"...1"}\NormalTok{))) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{drop\_na}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{join\_col =} \KeywordTok{paste0}\NormalTok{(}\KeywordTok{month}\NormalTok{(date), }\KeywordTok{year}\NormalTok{(date)))}

\NormalTok{alsi\_weights \textless{}{-}}\StringTok{ }\NormalTok{alsi\_weights }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\StringTok{"date"}\NormalTok{ =}\StringTok{ "...2"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.data}\OperatorTok{$}\NormalTok{SumCheck) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{date =} \KeywordTok{as.Date}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date) }\OperatorTok{+}\StringTok{ }\DecValTok{15}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\CommentTok{\# weights are at end of month, making start}
\StringTok{  }\KeywordTok{pivot\_longer}\NormalTok{(}\KeywordTok{setdiff}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(alsi\_weights), }\KeywordTok{c}\NormalTok{(}\StringTok{"SumCheck"}\NormalTok{, }\StringTok{"...2"}\NormalTok{))) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{drop\_na}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{join\_col =} \KeywordTok{paste0}\NormalTok{(}\KeywordTok{month}\NormalTok{(date), }\KeywordTok{year}\NormalTok{(date)))}

\CommentTok{\# joining data {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{full\_ret \textless{}{-}}\StringTok{ }\NormalTok{weekly\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{left\_join}\NormalTok{(}
\NormalTok{    month\_ret, }
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"join\_col"}\NormalTok{, }\StringTok{"name"}\NormalTok{), }
    \DataTypeTok{suffix =} \KeywordTok{c}\NormalTok{(}\StringTok{"\_week"}\NormalTok{, }\StringTok{"\_month"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}
    \DataTypeTok{date =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{date\_week, }
\NormalTok{    .data}\OperatorTok{$}\NormalTok{name, }
    \DataTypeTok{week\_ret =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{value\_week, }
    \DataTypeTok{month\_ret =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{value\_month, }
\NormalTok{    .data}\OperatorTok{$}\NormalTok{join\_col}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{left\_join}\NormalTok{(}
\NormalTok{    alsi\_weights,}
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"join\_col"}\NormalTok{, }\StringTok{"name"}\NormalTok{),}
    \DataTypeTok{suffix =} \KeywordTok{c}\NormalTok{(}\StringTok{"\_full"}\NormalTok{, }\StringTok{"\_weights"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}
    \DataTypeTok{date =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{date\_full,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{name,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{week\_ret,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{month\_ret,}
    \DataTypeTok{month\_weight\_start =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{value,}
    \DataTypeTok{month\_index =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{join\_col}
\NormalTok{  )}

\CommentTok{\# keeping complete cases only {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\NormalTok{complete\_per \textless{}{-}}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{complete.cases}\NormalTok{(full\_ret))}\OperatorTok{/}\KeywordTok{nrow}\NormalTok{(full\_ret)}
\CommentTok{\# data is 98.2\% complete}

\NormalTok{incomp\_weight\_per \textless{}{-}}\StringTok{ }\KeywordTok{sum}\NormalTok{(full\_ret[}\OperatorTok{!}\KeywordTok{complete.cases}\NormalTok{(full\_ret),]}\OperatorTok{$}\NormalTok{month\_weight\_start, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{/}\StringTok{ }
\StringTok{  }\KeywordTok{sum}\NormalTok{(full\_ret}\OperatorTok{$}\NormalTok{month\_weight\_start, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\CommentTok{\# but only 0.2\% of the weight is in the incomplete data, so it is largely}
\CommentTok{\# isolated to the long tail of small stocks that are outside of the}
\CommentTok{\# top 40 and 100 and are therefore not needed in this research}

\NormalTok{full\_ret \textless{}{-}}\StringTok{ }\NormalTok{full\_ret[}\KeywordTok{complete.cases}\NormalTok{(full\_ret),]}

\CommentTok{\# plot coverage}
\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_weight\_start }\OperatorTok{\textgreater{}=}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(date) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{count}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date, .data}\OperatorTok{$}\NormalTok{n)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"coverage through time"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/data_read_init-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# getting indices {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\NormalTok{top40\_month\_weights \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{size\_order =} \KeywordTok{rank}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.data}\OperatorTok{$}\NormalTok{month\_weight\_start)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{size\_order }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{40}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top40\_weight =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_weight\_start }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_weight\_start)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index, .data}\OperatorTok{$}\NormalTok{name, .data}\OperatorTok{$}\NormalTok{top40\_weight)}


\NormalTok{top100\_month\_weights \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{size\_order =} \KeywordTok{rank}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.data}\OperatorTok{$}\NormalTok{month\_weight\_start)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{size\_order }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{100}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{top100\_weight =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_weight\_start }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_weight\_start)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index, .data}\OperatorTok{$}\NormalTok{name, .data}\OperatorTok{$}\NormalTok{top100\_weight)}


\NormalTok{full\_ret \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{full\_join}\NormalTok{(}
\NormalTok{    top40\_month\_weights,}
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"month\_index"}\NormalTok{, }\StringTok{"name"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{full\_join}\NormalTok{(}
\NormalTok{    top100\_month\_weights,}
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"month\_index"}\NormalTok{, }\StringTok{"name"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{date,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{name,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{week\_ret,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{month\_ret,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{top40\_weight,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{top100\_weight,}
    \DataTypeTok{alsi\_weight =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{month\_weight\_start,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{month\_index}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{replace\_na}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{top40\_weight =} \DecValTok{0}\NormalTok{, }\DataTypeTok{top100\_weight =} \DecValTok{0}\NormalTok{))}
...
\NormalTok{full\_ret \textless{}{-}}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"data/full\_ret.rds"}\NormalTok{)}
\NormalTok{sample\_est\_wind \textless{}{-}}\StringTok{ }\DecValTok{400}

\NormalTok{rebal\_est\_ranges \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date, .data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{distinct}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{start\_date =} \KeywordTok{shift}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date, sample\_est\_wind)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{end\_date =} \KeywordTok{shift}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date, }\DecValTok{1}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{na.omit}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index, .data}\OperatorTok{$}\NormalTok{start\_date, .data}\OperatorTok{$}\NormalTok{end\_date)}

\NormalTok{model\_rebal\_dat \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{month\_index =}\NormalTok{ rebal\_est\_ranges}\OperatorTok{$}\NormalTok{month\_index, }\DataTypeTok{data =} \KeywordTok{list}\NormalTok{(}\OtherTok{NULL}\NormalTok{))}

\CommentTok{\# Looping through to find data}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq\_along}\NormalTok{(rebal\_est\_ranges}\OperatorTok{$}\NormalTok{month\_index)) \{}
  \CommentTok{\# need to find full data histories first}
\NormalTok{  full\_hist\_ids \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{rebal\_est\_ranges[i, ]}\OperatorTok{$}\NormalTok{end\_date }\OperatorTok{\&}\StringTok{ }
\StringTok{             }\NormalTok{.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{rebal\_est\_ranges[i, ]}\OperatorTok{$}\NormalTok{start\_date) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{name) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{count}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{n }\OperatorTok{==}\StringTok{ }\NormalTok{sample\_est\_wind) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{pull}\NormalTok{(.data}\OperatorTok{$}\NormalTok{name)}
  \CommentTok{\# then we can use \%in\% to get those with full histories}
\NormalTok{  dat\_now \textless{}{-}}\StringTok{ }\NormalTok{full\_ret }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{\textless{}=}\StringTok{ }\NormalTok{rebal\_est\_ranges[i, ]}\OperatorTok{$}\NormalTok{end\_date }\OperatorTok{\&}\StringTok{ }
\StringTok{             }\NormalTok{.data}\OperatorTok{$}\NormalTok{date }\OperatorTok{\textgreater{}=}\StringTok{ }\NormalTok{rebal\_est\_ranges[i, ]}\OperatorTok{$}\NormalTok{start\_date }\OperatorTok{\&}
\StringTok{             }\NormalTok{.data}\OperatorTok{$}\NormalTok{name }\OperatorTok{\%in\%}\StringTok{ }\NormalTok{full\_hist\_ids)  }
  \CommentTok{\# then re{-}allocate weights}
\NormalTok{  hist\_adj\_weights40 \textless{}{-}}\StringTok{ }\NormalTok{dat\_now }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{size\_order =} \KeywordTok{rank}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.data}\OperatorTok{$}\NormalTok{alsi\_weight)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{size\_order }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{40}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{histadj\_top40\_weight =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{alsi\_weight }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{alsi\_weight)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index, .data}\OperatorTok{$}\NormalTok{name, .data}\OperatorTok{$}\NormalTok{histadj\_top40\_weight)}
\NormalTok{  hist\_adj\_weights100 \textless{}{-}}\StringTok{ }\NormalTok{dat\_now }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{group\_by}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{size\_order =} \KeywordTok{rank}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.data}\OperatorTok{$}\NormalTok{alsi\_weight)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{filter}\NormalTok{(.data}\OperatorTok{$}\NormalTok{size\_order }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{100}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{histadj\_top100\_weight =}\NormalTok{ .data}\OperatorTok{$}\NormalTok{alsi\_weight }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(.data}\OperatorTok{$}\NormalTok{alsi\_weight)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{month\_index, .data}\OperatorTok{$}\NormalTok{name, .data}\OperatorTok{$}\NormalTok{histadj\_top100\_weight)}
  \CommentTok{\# join back and prepare to save down}
\NormalTok{  dat\_now \textless{}{-}}\StringTok{ }\NormalTok{dat\_now }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{full\_join}\NormalTok{(}
\NormalTok{    hist\_adj\_weights40,}
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"month\_index"}\NormalTok{, }\StringTok{"name"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{full\_join}\NormalTok{(}
\NormalTok{    hist\_adj\_weights100,}
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"month\_index"}\NormalTok{, }\StringTok{"name"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{date,}
...
\NormalTok{    .data}\OperatorTok{$}\NormalTok{week\_ret,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{month\_ret,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{histadj\_top40\_weight,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{histadj\_top100\_weight,}
\NormalTok{    .data}\OperatorTok{$}\NormalTok{month\_index}
\NormalTok{  ) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{replace\_na}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{histadj\_top40\_weight =} \DecValTok{0}\NormalTok{, }\DataTypeTok{histadj\_top100\_weight =} \DecValTok{0}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{month\_index =}\NormalTok{ rebal\_est\_ranges[i, ]}\OperatorTok{$}\NormalTok{month\_index) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{nest}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{c}\NormalTok{(}\StringTok{"date"}\NormalTok{, }\StringTok{"name"}\NormalTok{, }\StringTok{"week\_ret"}\NormalTok{, }\StringTok{"month\_ret"}\NormalTok{, }\StringTok{"histadj\_top40\_weight"}\NormalTok{, }\StringTok{"histadj\_top100\_weight"}\NormalTok{))}
\NormalTok{  model\_rebal\_dat[i, ] \textless{}{-}}\StringTok{ }\NormalTok{dat\_now[}\DecValTok{1}\NormalTok{, ]}
\NormalTok{\}}

\KeywordTok{saveRDS}\NormalTok{(model\_rebal\_dat, }\DataTypeTok{file =} \StringTok{"data/model\_rebal\_dat.rds"}\NormalTok{)}
\KeywordTok{head}\NormalTok{(model\_rebal\_dat, }\DecValTok{6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
