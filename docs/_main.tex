...
\NormalTok{model\_rebal\_dat \textless{}{-}}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"data/model\_rebal\_dat.rds"}\NormalTok{)}
...
\NormalTok{out \textless{}{-}}\StringTok{ }\NormalTok{model\_rebal\_dat}\OperatorTok{$}\NormalTok{data[[}\DecValTok{1}\NormalTok{]]}

\NormalTok{tmp \textless{}{-}}\StringTok{ }\NormalTok{out }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(.data}\OperatorTok{$}\NormalTok{date, .data}\OperatorTok{$}\NormalTok{name, .data}\OperatorTok{$}\NormalTok{week\_ret) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{pivot\_wider}\NormalTok{(}\DataTypeTok{id\_cols =} \KeywordTok{c}\NormalTok{(}\StringTok{"date"}\NormalTok{, }\StringTok{"name"}\NormalTok{), }\DataTypeTok{names\_from =} \KeywordTok{c}\NormalTok{(}\StringTok{"name"}\NormalTok{), }\DataTypeTok{values\_from =} \KeywordTok{c}\NormalTok{(}\StringTok{"week\_ret"}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.data}\OperatorTok{$}\NormalTok{date) }
...
\StringTok{    }\KeywordTok{nest}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{c}\NormalTok{(}\StringTok{"date"}\NormalTok{, }\StringTok{"name"}\NormalTok{, }\StringTok{"week\_ret"}\NormalTok{, }\StringTok{"month\_ret"}\NormalTok{, }\StringTok{"top40\_weight"}\NormalTok{, }\StringTok{"top100\_weight"}\NormalTok{))}
...
##   month_index data                 
##   <chr>       <list>               
## 1 102003      <tibble [75,749 x 6]>
## 2 112003      <tibble [76,103 x 6]>
## 3 122003      <tibble [76,373 x 6]>
## 4 12004       <tibble [76,634 x 6]>
## 5 22004       <tibble [76,948 x 6]>
## 6 32004       <tibble [77,186 x 6]>
\end{verbatim}
